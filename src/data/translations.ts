...
export const translations: Record<Language, TranslationKeys> = {
  ...
  heroName: "Saikrishna Kandukuri",
  heroTitle: "Cloud & Platform Engineer",
  heroDescription: "Cloud Engineer · Platform Engineer · Site Reliability Engineer. 3.5 years of experience, 7+ projects delivered, 4 certifications. Multi-cloud expert across AWS, Azure & GCP. Building scalable infrastructure, automating everything, and ensuring production reliability at scale.",
    heroCta: "Get in Touch",
    heroResume: "View Resume",
  aboutTitle: "About Me",
  aboutP1: "My name is Saikrishna Kandukuri and I have 3.5 years of experience as a Cloud & Platform Engineer. I have delivered 7+ projects and earned 4 certifications.",
  aboutP2: "I specialize in designing resilient, scalable infrastructure and building internal developer platforms that empower teams to ship faster and more reliably.",
  aboutYears: "3.5",
